/**
 * React Hook for fetching Withdrawal Requests data
 * Uses TanStack Query for caching and state management
 */

import * as React from 'react'
import { useQuery } from '@tanstack/react-query'
import { fetchWithdrawalRequests } from '@/lib/services/portfolio-service'
import type { WithdrawalRequestItem, WithdrawalRequestStatus } from '@/lib/services/types'
